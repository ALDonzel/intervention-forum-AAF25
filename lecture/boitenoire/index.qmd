...
[https://journals.openedition.org/traces/8499](https://journals.openedition.org/traces/8499)

Article un peu loin de notre sujet mais qui offre qq réflexions intéressantes, les 4/5 premières questions sont à lire : 
...
**Infrastructure : ensemble de canaux et de connexions qui ne sont pas forcément visibles**. 2 choses : 
    ...
    * ingénieurs français du rail au XIXe différencient infrastructure (tout ce qui précèdent : enquêtes, plans...) et superstructure (les rails eux-mêmes). Cela aboutie a une différence entre sphere publique (infra) et privée (super)
